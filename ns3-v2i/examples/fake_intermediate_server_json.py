...
*
* Authors: 
*  Hadhoum Hajjaj <hadhoum.hajjaj@nist.gov>
*  Raphael Barbau
*/"""
...
def main():
    ...
    try:
        ...
        traffic_light = v2x.generated.TrafficLightObject(
            pos_x=-88.21, pos_y=-145.86, pos_z=20.0, 
            vel_x = 0, vel_y = 0, vel_z = 0, time_remaining = 60)
        objects.append(traffic_light)
        
        vehicle = v2x.generated.VehicleObject(
            pos_x=-84.98, pos_y=-20.00, pos_z=0.5, 
